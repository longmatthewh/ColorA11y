...
(function () {
    ...
    var getLuminanceFromRGB = function getLuminanceFromRGB(rgbColor) {
        return 0.2126 * getsRGB(rgbColor.red) + 0.7152 * getsRGB(rgbColor.green) + 0.0722 * getsRGB(rgbColor.blue);
    };
